...
/*   Updated: 2025/08/28 00:49:51 by gustavo          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if ((get_timestamp() - philo->rules->start_time) > rules->time_to_die + 2
	...
	if ((get_timestamp() - philo[i].last_meal) > rules->time_to_die + 2
